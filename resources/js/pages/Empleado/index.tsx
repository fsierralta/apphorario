...
interface PageProps extends FlashMessage {
  empleados: {
    data: Empleado[];
...
const Index = () => {
  ...
  const data: Empleado[] = empleados.data || []; // Cambia esto según la estructura de tu respuesta 
  const links: PaginationLink[] = empleados.links || []; // Cambia esto según la estructura de tu respuesta 
  console.log(empleados,flash);
